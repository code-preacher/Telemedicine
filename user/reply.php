       ...
       $lib->check_login2();
       $crud->updateStatus2($_GET['id'],$_SESSION['id']);
      ...
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content">
            ...
            <?php
            $doctor=$crud->displayUser3('doctor',$_GET['id']); 
            $qt=$crud->displayAllWithOr2($doctor['email'],$_SESSION['id']);
            $qc=$crud->countAllById66($doctor['email'],$_SESSION['id']);
            ?>
            <div class='row'>
                    ...
                    <div class="direct-chat-messages">
                      ...
                      if ($qt) {
                       ...
                       foreach($qt as $dy){
                        ...
                        $user=$crud->displayUser3('user',$_SESSION['id']);
                        ?>
